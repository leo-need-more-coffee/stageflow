...
На карточке это две половины: над разделителем то, что узел читает, под ним —
то, что пишет.

![Карточка стадии на холсте](img/ref-node-card.png){ width="278" }

Панель справа — тот же узел в виде формы, собранной по спецификации стадии:

![Тот же узел в инспекторе](img/ref-inspector.png){ width="372" }
