...
Вот во что спецификация выше превращается на холсте: иконка, описание,
аргументы, которые узел читает, и выходы, которые он пишет.

![Карточка стадии, нарисованная по спецификации](img/ref-hello-card.png){ width="278" }
