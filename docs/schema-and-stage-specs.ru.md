...
Редактор — как раз такой инструмент. Своих стадий у него нет: он спрашивает
спецификации у бэкенда и рисует по ним палитру, карточки и формы аргументов.

![Редактор, работающий на спецификациях бэкенда](img/tut-final.png)
