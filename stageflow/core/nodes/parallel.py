...
См. MEMORY_MODEL.md §5. Фрейм иммутабелен, поэтому веткам отдаётся один и тот
...
class ParallelNode(Node):
    ...
    def _dropped(
        ...
        существовало ДО ``parallel``, остаётся branch-local scratch (см.
        MEMORY_MODEL.md §5 — так же ведёт себя AWS Step Functions). Поведение
